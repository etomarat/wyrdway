...
# Езда по оффроуду наносит небольшой урон (как "царапины/камни/вибрация"), но только когда мы
# реально движемся. Если стоим на месте вне дороги — урона нет.
#
# Урон применяется как rate (hp/sec): damage = offroad_damage_per_sec * dt.
TUNING.DRIVE.offroad_damage_per_sec = 0.1
# Порог скорости (units/sec), ниже которого урон на оффроуде не применяется.
TUNING.DRIVE.offroad_damage_min_speed = 0.5

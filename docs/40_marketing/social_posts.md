...
- Retro road‑trip roguelite: drive, raid, extract, return
- Bite‑sized POI raids under time pressure
- Outrun the return chase
- Play in the browser (Web) + downloads for Windows / macOS / Linux
- Made for the TIC‑80 fantasy console (240×136 / 16 colors)
- Russian backroads + techno‑mystic anomalies

## 2) Банк коротких формулировок (RU)

- Роад‑трип роглайт: едешь → вылазка на POI → лут → возвращаешься под давлением
- Короткие рейды на POI: быстро схватил и ушёл
- На обратном пути тебя догоняет «Сущность»
- Можно играть в браузере (Web) и скачать на Windows / macOS / Linux
- TIC‑80: 240×136, 16 цветов, ретро‑вайб
- Российская глубинка + техно‑мистика
